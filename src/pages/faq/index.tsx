          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10">
            <Link to="#">
              <div className="flex items-center justify-between gap-2 border border-border rounded-md p-4 group">
                ...
                <div className="flex items-center justify-center rounded-full dark:text-white group-hover:bg-gray-200 group-hover:text-black transition-colors duration-300 size-10">
                  <ChevronLeft size={16} />
                </div>
              </div>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10">
            <div className="border border-border space-y-6 p-4">
              ...
              <div className="flex justify-center">
                <Link to="#">
                  <div className="text-white bg-red-900 hover:bg-primary px-4 py-2 font-semibold rounded-md transition-colors duration-200">
                    شروع گفتگو آنلاین
                  </div>
                </Link>
              </div>
            ...
            <div className="border border-border space-y-6 p-4">
              ...
              <div className="flex justify-center">
                <Link to="#">
                  <div className=" text-primary border border-primary hover:text-white hover:bg-primary px-4 py-2 font-semibold rounded-md transition-colors duration-200">
                    شروع گفتگو آنلاین
                  </div>
                </Link>
              </div>
